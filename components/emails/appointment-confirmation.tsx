...
import { Link, Section, Text, Hr, Button } from "react-email";
...
export const AppointmentConfirmationEmail = ({
  ...
  return (
    <EmailLayout
      ...
      preview={`Appointment Confirmed: ${serviceTitle}`}
      socialHandles={socialHandles}
    >
      <Section className="relative">
        <Text className="text-primary text-base leading-[26px] font-medium"></Text>
        <Text className="text-sm">
          Dear <strong>{customerName}</strong>, we are delighted to confirm your
          upcoming consultation for <strong>{serviceTitle}</strong>.
        </Text>
            ...
            {serviceSlug === "prom" && (
              <div className="border-primary mt-6 rounded border p-4 text-center">
                ...
                <ul className="list-disc pl-5 text-left text-sm">
                  ...
                  <li>
                    Bring at least three style inspirations to discuss with the
                    head designer.
                  </li>
                  <li>
                    Think about the color palette that best suits your skin tone
                    and theme.
                  </li>
                </ul>
              </div>
        ...
        <div className="border-primary mt-6 rounded border-l-4 bg-gray-50 p-4">
          ...
          {location === "in-person" && (
            <Text className="text-sm">
              Parking is available right in front of 1211. The address appears
              as an auto body shop/warehouse on the map, which is accurate, and
              our store is located inside the building.{" "}
              <Link
