  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Focus state.
        "has-[[data-slot=input-group-control]:focus-visible]:border-primary has-[[data-slot=input-group-control]:focus-visible]:ring-primary/50 has-[[data-slot=input-group-control]:focus-visible]:ring-0",
