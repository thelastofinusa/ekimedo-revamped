...
interface CustomerEnquiryNotificationEmailProps {
  fullName: string;
  eventType: string;
  socialHandles?: SOCIAL_QUERY_RESULT;
}

export const CustomerEnquiryNotificationEmail = ({
  fullName,
  eventType,
  socialHandles,
}: CustomerEnquiryNotificationEmailProps) => {
  return (
    <EmailLayout
    ...
    >
      ...
      <Text className="mt-4 text-sm leading-6 text-[#3c4043]">
        Thank you for reaching out regarding your <strong>{eventType}</strong>{" "}
        enquiry. We will review your request and get back to you as soon as
...
export default CustomerEnquiryNotificationEmail;
